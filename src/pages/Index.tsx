  ...
  const services = [
    {
      ...
      description: "Полная диагностика электрооборудования грузовых автомобилей"
    },
    {
      icon: "Wrench",
      title: "Ремонт генераторов и стартеров",
      description: "Профессиональный ремонт и замена узлов электросистемы"
    },
    {
      icon: "Battery",
      title: "Аккумуляторные работы",
      description: "Диагностика, зарядка, замена аккумуляторных батарей"
    },
    {
      icon: "Lightbulb",
      title: "Ремонт освещения",
      description: "Восстановление работы всех систем освещения автомобиля"
    },
    {
      icon: "Settings",
      title: "Ремонт блоков управления",
      description: "Диагностика и ремонт ЭБУ, ABS, EBS и других систем"
    },
    {
      icon: "Cable",
      title: "Проводка и датчики",
      description: "Поиск и устранение обрывов, замена датчиков"
    }
  ];
